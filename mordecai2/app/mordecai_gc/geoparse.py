...
https://github.com/openeventdata/mordecai/ for instructions on updating.""".format(es_date, mod_date))
    ...
    def get_admin1(self, country_code3, admin1_code):
        """
        ...
        """
        lookup_key = ".".join([country_code3, admin1_code])
        try:
    ...
    def format_geonames(self, entry, searchterm=None):
        ...
        try:
            ...
            new_res = {"admin1" : self.get_admin1(entry['country_code3'], entry['admin1_code']),
                  "lat" : lat,
                  "lon" : lon,
